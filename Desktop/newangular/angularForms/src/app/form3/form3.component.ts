...
export class Form3Component {
  ...
  ngOnInit(){
    ...
    this.reactiveForm = new FormGroup({
      email:new FormControl('aradhyaambole@gmail.com',[Validators.required,Validators.email]),
      password:new FormControl('thisispassword',[Validators.required,Validators.minLength(6)]),
      age:new FormControl(21,[Validators.required,Validators.min(18),Validators.max(40)])
    })
  }
